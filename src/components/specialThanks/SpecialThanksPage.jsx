...
import specialThanksImg from 'assets/specialThanks.png';
...
export default function SpecialThanks() {
  ...
  return (
    <div
      className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-1/2 z-30 h-auto"
      onClick={closeThanksPopup}
      onKeyDown={closeThanksPopup}
      role="presentation"
    >
      <img src={specialThanksImg} alt="specialThanks" />
